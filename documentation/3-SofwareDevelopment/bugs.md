...
|--------|-------|----------|--------|------------|
| [BUG-20260609-001](bug-details/BUG-20260609-001_drop_work_domain_prefix.md) | Drop `work.` domain prefix from published topic names (system-wide rename; paired with CodeValdAI) | High | 🚀 In Progress | SharedLib dual-emit shim; paired CodeValdAI BUG-20260609-001 |
