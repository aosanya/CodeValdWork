...
| MVP-WORK-015 | HTTP convenience routes — mirror CodeValdComm pattern; routes for Task, TaskGroup, Agent, relationships declared in registrar `RegisterRequest` for Cross dynamic proxy | ✅ Complete | MVP-WORK-013 |
