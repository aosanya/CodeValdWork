...
| FEAT-20260602-004 | Rollback / compensation semantics — design-only doc capturing the per-service contract for `POST /workflow-runs/{id}/rollback` | 🚀 In Progress | ~~FEAT-20260602-002~~ ✅, ~~FEAT-20260602-003~~ ✅ |
