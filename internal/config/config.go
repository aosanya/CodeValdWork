...
func Load() Config {
	...
	return Config{
		...
		SubscribeTopics: parseTopics(serverutil.EnvOrDefault("WORK_SUBSCRIBE_TOPICS", "ai.task.started,ai.task.completed,ai.task.failed,ai.todo.created,work.task.update,work.task.completed")),
	}
}
